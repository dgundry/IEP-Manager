...
public class CreateAccountView {
    private static final Logger logger = Logger.getLogger(CreateAccountView.class.getName());
        ...
        private void createPanels() {
            try {
                ...
                backgroundCreateAccountPanel.setBackground(
                        ImageIO.read(new File("src/com/mango/app/utilities/Ariel-City-of-Lawrenceburg1.png")));
