...
public class SecurityQuestionTwoView {
    private static final Logger logger = Logger.getLogger(SecurityQuestionTwoView.class.getName());
    ...
    public SecurityQuestionTwoView(){
        ...
        private void createComponents() {
            ...
            securityTwoHeader.setBounds(0,( int) (createAccountPanel.getHeight() * 0.48), createAccountPanel.getWidth(),15);
            ...
            securityTwoAnsHeader.setBounds(0, (int) (createAccountPanel.getHeight() * 0.62), createAccountPanel.getWidth(),15);
            ...
            createAccountPanel.add(securityTwoHeader);
            createAccountPanel.add(securityTwoText);
            createAccountPanel.add(securityTwoAnsHeader);
            createAccountPanel.add(securityTwoAnsText);
