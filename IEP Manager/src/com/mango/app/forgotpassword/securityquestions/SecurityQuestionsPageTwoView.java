...
public class SecurityQuestionsPageTwoView {
    ...
    private void createComponents() {
        ...
        securityTwoHeader.setBounds(0,( int) (securityQuestionsPanel.getHeight() * 0.48), securityQuestionsPanel.getWidth(),15);
        ...
        securityTwoAnsHeader.setBounds(0, (int) (securityQuestionsPanel.getHeight() * 0.62), securityQuestionsPanel.getWidth(),15);
        ...
        securityQuestionsPanel.add(securityTwoText);
