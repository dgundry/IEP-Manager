...
public class BasicInfoController {
    ...
    private static class NextLabelMouseListener implements MouseListener {
        ...
        public void mouseEntered(MouseEvent e) {
            label.setIcon(Images.BASIC_INFO_NEXT_HOVERED.getImageIcon());
        }
        ...
        public void mouseExited(MouseEvent e) {
            label.setIcon(Images.BASIC_INFO_NEXT_NO_HOVER.getImageIcon());
        }
    ...
    private static class BackLabelMouseListener implements MouseListener {
        ...
        @Override
        public void mouseEntered(MouseEvent e) {
            label.setIcon(Images.BASIC_INFO_BACK_HOVERED.getImageIcon());
        }
        ...
        @Override
        public void mouseExited(MouseEvent e) {
            label.setIcon(Images.BASIC_INFO_BACK_NO_HOVER.getImageIcon());
        }
